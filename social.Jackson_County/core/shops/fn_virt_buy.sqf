...
private _lakesideArray = ["Land_MBG_GER_RHUS_1","Land_MBG_GER_RHUS_1"];
private _hideoutObjs = [[["Altis", _altisArray], ["Tanoa", _tanoaArray], ["Jackson_County", _lakesideArray]]] call TON_fnc_terrainSort;
