...
[
 ...
 "plp_upm_WoodBarrierShortPoliceLightsOn"
];
...
*/
life_taxiStations = [
    ["taxi_spawn_lakeside",   "Lakeside", civilian],
    ["taxi_spawn_morrison",   "Morrison", civilian],
    ["taxi_spawn_losd",   "LosD", civilian],
    ["taxi_spawn_verwahrstelle",    "Verwahrplatz", civilian],

    ["taxi_spawn_lakeside",   "Lakeside", independent],
    ["taxi_spawn_morrison",   "Morrison", independent],
    ["taxi_spawn_losd",   "LosD", independent],
    ["taxi_spawn_verwahrstelle",    "Verwahrplatz", independent],

    ["taxi_spawn_lakeside",   "Lakeside", east],
    ["taxi_spawn_morrison",   "Morrison", east],
    ["taxi_spawn_losd",   "LosD", east],
    ["taxi_spawn_verwahrstelle",    "Verwahrplatz", east],

    ["taxi_spawn_lakeside",  "Lakeside", west],
    ["taxi_spawn_morrison",  "Morrison", west],
    ["taxi_spawn_losd",  "LosD", west],
    ["taxi_spawn_verwahrstelle",   "Verwahrplatz", west]
];
/*
