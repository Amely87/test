...
if(player != vehicle player) exitWith {titleText ["Steig aus dem Fahrzeug","PLAIN"]; life_action_inUse = false;};
...
//Schaden am Fahrzeug global machen
	...
	[_target,0] remoteExec ["life_fnc_lockVehicle",_target];
		...
		[_target,"locked",false,true] remoteExec ["TON_fnc_setObjVar",HC_Life];
	} else {
	...
	playSound3D ["A3R_Client\sounds\autoscheibe.ogg",_target,false,getposASL _target,1.2,1,130];
