...
/* System Settings */
    ...
    fuelCan_refuel = 5; //Cost to refuel an empty fuel canister at the fuel station pumps. (Be wary of your buy/sell prices on fuel cans to prevent exploits...)
    ...
    paycheck_cop = 135; //Payment for cops
    paycheck_civ = 80; //Payment for civillians
    paycheck_med = 110; //Payment for medics
	paycheck_lac = 130; //Amount of cash on bank for the lac
