...
class CfgSpawnPoints {
    ...
    class Jackson_County {	
		...
		class Medic {
			class Lakeside_Medic {
				displayName = "Hospital Lakeside";
				spawnMarker = "Lakeside_Medic";
				icon = "\a3\ui_f\data\map\MapControl\hospital_ca.paa";
				conditions = "";
			};	

			class spawn_medic_morrison {
				displayName = "Hospital Morisson";
		...
		class Lac {
			class lac_spawn_lakeside {
				displayName = "SAC Lakeside";
				spawnMarker = "spawn_lac";
				icon = "\a3\ui_f\data\map\MapControl\hospital_ca.paa";
				conditions = "";
			};		
		}; 		
