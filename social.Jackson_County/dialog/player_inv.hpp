	...
	class controls {
		...
		*/
		...
		class ButtonCell : Life_RscButtonMenu {
			idc = 2014;
			onButtonClick = "createDialog ""Life_my_smartphone"";switch(playerSide) do {case west:{ctrlShow[2011,false];ctrlShow[2016,false];};case independent:{ctrlShow[2011,false];ctrlShow[2016,false];};};";
